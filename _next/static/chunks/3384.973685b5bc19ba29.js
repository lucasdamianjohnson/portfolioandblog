...
`;o.v.IncludesShadersStoreWGSL[f]=a;let t={name:f,shader:a}},50973:function(e,r,n){var o=n(29427);let f=`#ifdef LOGARITHMICDEPTH
uniform logarithmicDepthConstant: f32;varying vFragmentDepth: f32;
#endif
`;o.v.IncludesShadersStoreWGSL.logDepthDeclaration=f},22221:function(e,r,n){var o=n(29427);let f=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;o.v.IncludesShadersStoreWGSL.mainUVVaryingDeclaration=f},31896:function(e,r,n){var o=n(29427);let f=`struct Mesh {world : mat4x4<f32>,
visibility : f32,};var<uniform> mesh : Mesh;
#define WORLD_UBO
`;o.v.IncludesShadersStoreWGSL.meshUboDeclaration=f},74575:function(e,r,n){var o=n(29427);let f=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
